...
LDFLAGS=-I$(OPENSSL_DIR)/include -lpthread -ldl -lm #-lz
...
gzcms-cli : gzcms_lib
	$(CC) -g  -o ./$(TARGET_DIR)/gzcms-cli  $(SRC_DIR)/gzcms-cli.c -L./$(TARGET_DIR)/ -lgzcms  $(CFLAGS) $(LDFLAGS)  -D_NO_CA_ -D_NO_NEWT_
	cp ./$(TARGET_DIR)/gzcms-cli ./

gzcms-cli2 :
	$(CC) -g  -o ./$(TARGET_DIR)/gzcms-cli  $(SRC_DIR)/gzcms-cli.c $(GZCMS_OBJS)  $(OBJ_DIR)/libcrypto.a    $(CFLAGS) $(LDFLAGS)  -D_NO_CA_ -D_NO_NEWT_
	cp ./$(TARGET_DIR)/gzcms-cli ./

api : $(SRC_DIR)/gzpki_api.c
	$(CC)  -g -o ./$(TARGET_DIR)/gzpki_api.o -c  $(SRC_DIR)/gzpki_api.c  $(LDFLAGS)  -I$(OPENSSL_DIR)/include 

ca: $(SRC_DIR)/gzpki_ca.c
	$(CC) -g  -o ./$(TARGET_DIR)/gzpki_ca.o -c  $(SRC_DIR)/gzpki_ca.c  $(LDFLAGS) -I$(SQLITE_INC) -D__WITH_SQLITE__  -I$(OPENSSL_DIR)/include 
...
enc : $(SRC_DIR)/gzpki_enc.c
	$(CC) -g  -o ./$(TARGET_DIR)/gzpki_enc.o -c  $(SRC_DIR)/gzpki_enc.c   $(LDFLAGS)  -I$(OPENSSL_DIR)/include 

common : $(SRC_DIR)/gzpki_common.c
	$(CC) -g  -o ./$(TARGET_DIR)/gzpki_common.o -c  $(SRC_DIR)/gzpki_common.c  $(LDFLAGS) -Wwrite-strings  -I$(OPENSSL_DIR)/include 

cms : $(SRC_DIR)/gzpki_cms.c 
	$(CC) -o ./$(TARGET_DIR)/gzpki_cms.o -c  $(SRC_DIR)/gzpki_cms.c  $(LDFLAGS)  -I$(OPENSSL_DIR)/include 
...
req: $(SRC_DIR)/gzpki_req.c
	$(CC) -g  -o ./$(TARGET_DIR)/gzpki_req.o -c  $(SRC_DIR)/gzpki_req.c  $(LDFLAGS)  -I$(OPENSSL_DIR)/include 

x509: $(SRC_DIR)/gzpki_x509.c
	$(CC) -g  -o ./$(TARGET_DIR)/gzpki_x509.o -c  $(SRC_DIR)/gzpki_x509.c  $(LDFLAGS)  -I$(OPENSSL_DIR)/include 

ocsp: $(SRC_DIR)/gzpki_ocsp.c
	$(CC) -g  -o ./$(TARGET_DIR)/gzpki_ocsp.o -c  $(SRC_DIR)/gzpki_ocsp.c    $(LDFLAGS)  -I$(OPENSSL_DIR)/include 
