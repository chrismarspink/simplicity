...
/* Serialized OID's */
static const unsigned char so[7924] = {
    ...
    0x60,0x86,0x48,0x01,0x65,0x03,0x05,0x01,0x01,  /* [ 7761] OBJ_lea_128_ecb */
    0x60,0x86,0x48,0x01,0x65,0x03,0x05,0x01,0x02,  /* [ 7770] OBJ_lea_128_cbc */
    0x60,0x86,0x48,0x01,0x65,0x03,0x05,0x01,0x03,  /* [ 7779] OBJ_lea_128_ofb128 */
    0x60,0x86,0x48,0x01,0x65,0x03,0x05,0x01,0x04,  /* [ 7788] OBJ_lea_128_cfb128 */
    0x60,0x86,0x48,0x01,0x65,0x03,0x05,0x01,0x06,  /* [ 7797] OBJ_lea_128_gcm */
    0x60,0x86,0x48,0x01,0x65,0x03,0x05,0x01,0x07,  /* [ 7806] OBJ_lea_128_ccm */
    0x60,0x86,0x48,0x01,0x65,0x03,0x05,0x01,0x15,  /* [ 7815] OBJ_lea_192_ecb */
    0x60,0x86,0x48,0x01,0x65,0x03,0x05,0x01,0x16,  /* [ 7824] OBJ_lea_192_cbc */
    0x60,0x86,0x48,0x01,0x65,0x03,0x05,0x01,0x17,  /* [ 7833] OBJ_lea_192_ofb128 */
    0x60,0x86,0x48,0x01,0x65,0x03,0x05,0x01,0x18,  /* [ 7842] OBJ_lea_192_cfb128 */
    0x60,0x86,0x48,0x01,0x65,0x03,0x05,0x01,0x1A,  /* [ 7851] OBJ_lea_192_gcm */
    0x60,0x86,0x48,0x01,0x65,0x03,0x05,0x01,0x1B,  /* [ 7860] OBJ_lea_192_ccm */
    0x60,0x86,0x48,0x01,0x65,0x03,0x05,0x01,0x29,  /* [ 7869] OBJ_lea_256_ecb */
    0x60,0x86,0x48,0x01,0x65,0x03,0x05,0x01,0x2A,  /* [ 7878] OBJ_lea_256_cbc */
    0x60,0x86,0x48,0x01,0x65,0x03,0x05,0x01,0x2B,  /* [ 7887] OBJ_lea_256_ofb128 */
    0x60,0x86,0x48,0x01,0x65,0x03,0x05,0x01,0x2C,  /* [ 7896] OBJ_lea_256_cfb128 */
    0x60,0x86,0x48,0x01,0x65,0x03,0x05,0x01,0x2E,  /* [ 7905] OBJ_lea_256_gcm */
    0x60,0x86,0x48,0x01,0x65,0x03,0x05,0x01,0x2F,  /* [ 7914] OBJ_lea_256_ccm */
};
...
static const ASN1_OBJECT nid_objs[NUM_NID] = {
    ...
    {"LEA-128-ECB", "lea-128-ecb", NID_lea_128_ecb, 9, &so[7761]},
    {"LEA-128-CBC", "lea-128-cbc", NID_lea_128_cbc, 9, &so[7770]},
    {"LEA-128-OFB", "lea-128-ofb", NID_lea_128_ofb128, 9, &so[7779]},
    {"LEA-128-CFB", "lea-128-cfb", NID_lea_128_cfb128, 9, &so[7788]},
    {"id-lea128-GCM", "lea-128-gcm", NID_lea_128_gcm, 9, &so[7797]},
    {"id-lea128-CCM", "lea-128-ccm", NID_lea_128_ccm, 9, &so[7806]},
    {"LEA-192-ECB", "lea-192-ecb", NID_lea_192_ecb, 9, &so[7815]},
    {"LEA-192-CBC", "lea-192-cbc", NID_lea_192_cbc, 9, &so[7824]},
    {"LEA-192-OFB", "lea-192-ofb", NID_lea_192_ofb128, 9, &so[7833]},
    {"LEA-192-CFB", "lea-192-cfb", NID_lea_192_cfb128, 9, &so[7842]},
    {"id-lea192-GCM", "lea-192-gcm", NID_lea_192_gcm, 9, &so[7851]},
    {"id-lea192-CCM", "lea-192-ccm", NID_lea_192_ccm, 9, &so[7860]},
    {"LEA-256-ECB", "lea-256-ecb", NID_lea_256_ecb, 9, &so[7869]},
    {"LEA-256-CBC", "lea-256-cbc", NID_lea_256_cbc, 9, &so[7878]},
    {"LEA-256-OFB", "lea-256-ofb", NID_lea_256_ofb128, 9, &so[7887]},
    {"LEA-256-CFB", "lea-256-cfb", NID_lea_256_cfb128, 9, &so[7896]},
    {"id-lea256-GCM", "lea-256-gcm", NID_lea_256_gcm, 9, &so[7905]},
    {"id-lea256-CCM", "lea-256-ccm", NID_lea_256_ccm, 9, &so[7914]},
    {"LEA-128-CFB1", "lea-128-cfb1", NID_lea_128_cfb1},
    {"LEA-192-CFB1", "lea-192-cfb1", NID_lea_192_cfb1},
    {"LEA-256-CFB1", "lea-256-cfb1", NID_lea_256_cfb1},
    {"LEA-128-CFB8", "lea-128-cfb8", NID_lea_128_cfb8},
    {"LEA-192-CFB8", "lea-192-cfb8", NID_lea_192_cfb8},
    {"LEA-256-CFB8", "lea-256-cfb8", NID_lea_256_cfb8},
    {"LEA-128-CTR", "lea-128-ctr", NID_lea_128_ctr},
    {"LEA-192-CTR", "lea-192-ctr", NID_lea_192_ctr},
    {"LEA-256-CTR", "lea-256-ctr", NID_lea_256_ctr},
};
...
static const unsigned int obj_objs[NUM_OBJ] = {
    ...
    1195,    /* OBJ_lea_128_ecb                  2 16 840 1 101 3 5 1 1 */
    1196,    /* OBJ_lea_128_cbc                  2 16 840 1 101 3 5 1 2 */
    1197,    /* OBJ_lea_128_ofb128               2 16 840 1 101 3 5 1 3 */
    1198,    /* OBJ_lea_128_cfb128               2 16 840 1 101 3 5 1 4 */
    1199,    /* OBJ_lea_128_gcm                  2 16 840 1 101 3 5 1 6 */
    1200,    /* OBJ_lea_128_ccm                  2 16 840 1 101 3 5 1 7 */
    1201,    /* OBJ_lea_192_ecb                  2 16 840 1 101 3 5 1 21 */
    1202,    /* OBJ_lea_192_cbc                  2 16 840 1 101 3 5 1 22 */
    1203,    /* OBJ_lea_192_ofb128               2 16 840 1 101 3 5 1 23 */
    1204,    /* OBJ_lea_192_cfb128               2 16 840 1 101 3 5 1 24 */
    1205,    /* OBJ_lea_192_gcm                  2 16 840 1 101 3 5 1 26 */
    1206,    /* OBJ_lea_192_ccm                  2 16 840 1 101 3 5 1 27 */
    1207,    /* OBJ_lea_256_ecb                  2 16 840 1 101 3 5 1 41 */
    1208,    /* OBJ_lea_256_cbc                  2 16 840 1 101 3 5 1 42 */
    1209,    /* OBJ_lea_256_ofb128               2 16 840 1 101 3 5 1 43 */
    1210,    /* OBJ_lea_256_cfb128               2 16 840 1 101 3 5 1 44 */
    1211,    /* OBJ_lea_256_gcm                  2 16 840 1 101 3 5 1 46 */
    1212,    /* OBJ_lea_256_ccm                  2 16 840 1 101 3 5 1 47 */
