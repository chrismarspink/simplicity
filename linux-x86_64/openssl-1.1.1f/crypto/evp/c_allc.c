...
#ifndef OPENSSL_NO_LEA
    EVP_add_cipher(EVP_lea_128_ecb());
    EVP_add_cipher(EVP_lea_128_cbc());
    EVP_add_cipher(EVP_lea_128_cfb());
    EVP_add_cipher(EVP_lea_128_cfb1());
    EVP_add_cipher(EVP_lea_128_cfb8());
    EVP_add_cipher(EVP_lea_128_ctr());
    EVP_add_cipher(EVP_lea_128_ofb());
    EVP_add_cipher(EVP_lea_128_gcm());
    EVP_add_cipher(EVP_lea_128_ccm());
    EVP_add_cipher_alias(SN_lea_128_cbc, "LEA128");
    EVP_add_cipher_alias(SN_lea_128_cbc, "lea128");
    EVP_add_cipher(EVP_lea_192_ecb());
    EVP_add_cipher(EVP_lea_192_cbc());
    EVP_add_cipher(EVP_lea_192_cfb());
    EVP_add_cipher(EVP_lea_192_cfb1());
    EVP_add_cipher(EVP_lea_192_cfb8());
    EVP_add_cipher(EVP_lea_192_ctr());
    EVP_add_cipher(EVP_lea_192_ofb());
    EVP_add_cipher(EVP_lea_192_gcm());
    EVP_add_cipher(EVP_lea_192_ccm());
    EVP_add_cipher_alias(SN_lea_192_cbc, "LEA192");
    EVP_add_cipher_alias(SN_lea_192_cbc, "lea192");
    EVP_add_cipher(EVP_lea_256_ecb());
    EVP_add_cipher(EVP_lea_256_cbc());
    EVP_add_cipher(EVP_lea_256_cfb());
    EVP_add_cipher(EVP_lea_256_cfb1());
    EVP_add_cipher(EVP_lea_256_cfb8());
    EVP_add_cipher(EVP_lea_256_ctr());
    EVP_add_cipher(EVP_lea_256_ofb());
    EVP_add_cipher(EVP_lea_256_gcm());
    EVP_add_cipher(EVP_lea_256_ccm());
    EVP_add_cipher_alias(SN_lea_256_cbc, "LEA256");
    EVP_add_cipher_alias(SN_lea_256_cbc, "lea256");
#endif
