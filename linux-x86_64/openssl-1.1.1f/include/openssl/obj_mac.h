...
#define OBJ_LEA_cipher_suite            OBJ_csor,5L

#define OBJ_lea         OBJ_LEA_cipher_suite,1L

#define SN_lea_128_ecb          "LEA-128-ECB"
#define LN_lea_128_ecb          "lea-128-ecb"
#define NID_lea_128_ecb         1195
#define OBJ_lea_128_ecb         OBJ_lea,1L

#define SN_lea_128_cbc          "LEA-128-CBC"
#define LN_lea_128_cbc          "lea-128-cbc"
#define NID_lea_128_cbc         1196
#define OBJ_lea_128_cbc         OBJ_lea,2L

#define SN_lea_128_ofb128               "LEA-128-OFB"
#define LN_lea_128_ofb128               "lea-128-ofb"
#define NID_lea_128_ofb128              1197
#define OBJ_lea_128_ofb128              OBJ_lea,3L

#define SN_lea_128_cfb128               "LEA-128-CFB"
#define LN_lea_128_cfb128               "lea-128-cfb"
#define NID_lea_128_cfb128              1198
#define OBJ_lea_128_cfb128              OBJ_lea,4L

#define SN_lea_128_gcm          "id-lea128-GCM"
#define LN_lea_128_gcm          "lea-128-gcm"
#define NID_lea_128_gcm         1199
#define OBJ_lea_128_gcm         OBJ_lea,6L

#define SN_lea_128_ccm          "id-lea128-CCM"
#define LN_lea_128_ccm          "lea-128-ccm"
#define NID_lea_128_ccm         1200
#define OBJ_lea_128_ccm         OBJ_lea,7L

#define SN_lea_192_ecb          "LEA-192-ECB"
#define LN_lea_192_ecb          "lea-192-ecb"
#define NID_lea_192_ecb         1201
#define OBJ_lea_192_ecb         OBJ_lea,21L

#define SN_lea_192_cbc          "LEA-192-CBC"
#define LN_lea_192_cbc          "lea-192-cbc"
#define NID_lea_192_cbc         1202
#define OBJ_lea_192_cbc         OBJ_lea,22L

#define SN_lea_192_ofb128               "LEA-192-OFB"
#define LN_lea_192_ofb128               "lea-192-ofb"
#define NID_lea_192_ofb128              1203
#define OBJ_lea_192_ofb128              OBJ_lea,23L

#define SN_lea_192_cfb128               "LEA-192-CFB"
#define LN_lea_192_cfb128               "lea-192-cfb"
#define NID_lea_192_cfb128              1204
#define OBJ_lea_192_cfb128              OBJ_lea,24L

#define SN_lea_192_gcm          "id-lea192-GCM"
#define LN_lea_192_gcm          "lea-192-gcm"
#define NID_lea_192_gcm         1205
#define OBJ_lea_192_gcm         OBJ_lea,26L

#define SN_lea_192_ccm          "id-lea192-CCM"
#define LN_lea_192_ccm          "lea-192-ccm"
#define NID_lea_192_ccm         1206
#define OBJ_lea_192_ccm         OBJ_lea,27L

#define SN_lea_256_ecb          "LEA-256-ECB"
#define LN_lea_256_ecb          "lea-256-ecb"
#define NID_lea_256_ecb         1207
#define OBJ_lea_256_ecb         OBJ_lea,41L

#define SN_lea_256_cbc          "LEA-256-CBC"
#define LN_lea_256_cbc          "lea-256-cbc"
#define NID_lea_256_cbc         1208
#define OBJ_lea_256_cbc         OBJ_lea,42L

#define SN_lea_256_ofb128               "LEA-256-OFB"
#define LN_lea_256_ofb128               "lea-256-ofb"
#define NID_lea_256_ofb128              1209
#define OBJ_lea_256_ofb128              OBJ_lea,43L

#define SN_lea_256_cfb128               "LEA-256-CFB"
#define LN_lea_256_cfb128               "lea-256-cfb"
#define NID_lea_256_cfb128              1210
#define OBJ_lea_256_cfb128              OBJ_lea,44L

#define SN_lea_256_gcm          "id-lea256-GCM"
#define LN_lea_256_gcm          "lea-256-gcm"
#define NID_lea_256_gcm         1211
#define OBJ_lea_256_gcm         OBJ_lea,46L

#define SN_lea_256_ccm          "id-lea256-CCM"
#define LN_lea_256_ccm          "lea-256-ccm"
#define NID_lea_256_ccm         1212
#define OBJ_lea_256_ccm         OBJ_lea,47L

#define SN_lea_128_cfb1         "LEA-128-CFB1"
#define LN_lea_128_cfb1         "lea-128-cfb1"
#define NID_lea_128_cfb1                1213

#define SN_lea_192_cfb1         "LEA-192-CFB1"
#define LN_lea_192_cfb1         "lea-192-cfb1"
#define NID_lea_192_cfb1                1214

#define SN_lea_256_cfb1         "LEA-256-CFB1"
#define LN_lea_256_cfb1         "lea-256-cfb1"
#define NID_lea_256_cfb1                1215

#define SN_lea_128_cfb8         "LEA-128-CFB8"
#define LN_lea_128_cfb8         "lea-128-cfb8"
#define NID_lea_128_cfb8                1216

#define SN_lea_192_cfb8         "LEA-192-CFB8"
#define LN_lea_192_cfb8         "lea-192-cfb8"
#define NID_lea_192_cfb8                1217

#define SN_lea_256_cfb8         "LEA-256-CFB8"
#define LN_lea_256_cfb8         "lea-256-cfb8"
#define NID_lea_256_cfb8                1218

#define SN_lea_128_ctr          "LEA-128-CTR"
#define LN_lea_128_ctr          "lea-128-ctr"
#define NID_lea_128_ctr         1219

#define SN_lea_192_ctr          "LEA-192-CTR"
#define LN_lea_192_ctr          "lea-192-ctr"
#define NID_lea_192_ctr         1220

#define SN_lea_256_ctr          "LEA-256-CTR"
#define LN_lea_256_ctr          "lea-256-ctr"
#define NID_lea_256_ctr         1221
