...
our %config = (
  ...
  perl_version => "5.26.1",
  perlargv => [ "linux-x86_64", "no-engine" ],
  perlenv => {
      "AR" => undef,
      "ARFLAGS" => undef,
      "AS" => undef,
  ...
  sdirs => [ "objects", "md4", "md5", "sha", "mdc2", "hmac", "ripemd", "whrlpool", "poly1305", "blake2", "siphash", "sm3", "des", "aes", "rc2", "rc4", "idea", "aria", "lea", "bf", "cast", "camellia", "seed", "sm4", "chacha", "modes", "bn", "ec", "rsa", "dsa", "dh", "sm2", "dso", "buffer", "bio", "stack", "lhash", "rand", "err", "evp", "asn1", "pem", "x509", "x509v3", "conf", "txt_db", "pkcs7", "pkcs12", "comp", "ocsp", "ui", "cms", "ts", "srp", "cmac", "ct", "async", "kdf", "store" ],
  shlib_major => "1",
  shlib_minor => "1",
    ...
    "depends" =>
        {
            ...
            "test/buildtest_c_lea" =>
                [
                    "libcrypto",
                    "libssl",
                ],
            "test/buildtest_c_lea_locl" =>
                [
                    "libcrypto",
                    "libssl",
                ],
            ...
            "crypto/lea" =>
                {
                    "deps" =>
                        [
                            "crypto/lea/lea_cbc.o",
                            "crypto/lea/lea_cfb.o",
                            "crypto/lea/lea_core.o",
                            "crypto/lea/lea_ctr.o",
                            "crypto/lea/lea_ecb.o",
                            "crypto/lea/lea_gcm.o",
                            "crypto/lea/lea_misc.o",
                            "crypto/lea/lea_ofb.o",
                        ],
                    "products" =>
                        {
                            "lib" =>
    ...
    "generate" =>
        {
            ...
            "test/buildtest_lea.c" =>
                [
                    "test/generate_buildtest.pl",
                    "lea",
                ],
            "test/buildtest_lea_locl.c" =>
                [
                    "test/generate_buildtest.pl",
                    "lea_locl",
                ],
    ...
    "includes" =>
        {
            ...
            "test/buildtest_lea.o" =>
                [
                    "include",
                ],
            "test/buildtest_lea_locl.o" =>
                [
                    "include",
                ],
    ...
    "sources" =>
        {
            ...
            "crypto/lea/lea_cbc.o" =>
                [
                    "crypto/lea/lea_cbc.c",
                ],
            "crypto/lea/lea_cfb.o" =>
                [
                    "crypto/lea/lea_cfb.c",
                ],
            "crypto/lea/lea_core.o" =>
                [
                    "crypto/lea/lea_core.c",
                ],
            "crypto/lea/lea_ctr.o" =>
                [
                    "crypto/lea/lea_ctr.c",
                ],
            "crypto/lea/lea_ecb.o" =>
                [
                    "crypto/lea/lea_ecb.c",
                ],
            "crypto/lea/lea_gcm.o" =>
                [
                    "crypto/lea/lea_gcm.c",
                ],
            "crypto/lea/lea_misc.o" =>
                [
                    "crypto/lea/lea_misc.c",
                ],
            "crypto/lea/lea_ofb.o" =>
                [
                    "crypto/lea/lea_ofb.c",
                ],
            "crypto/lhash/lh_stats.o" =>
                [
